...
public class CountryArrayManager {
    ...
    public CountryData[] filterContinent(String continent) {
        /* TODO */
        CountryData[] newArray = Arrays.stream(Arrays.copyOf(countryDataArray, length)).filter(countryData -> countryData.getContinent().equals(continent)).toArray(CountryData[]::new);
        return newArray;
    }
    ...
    public CountryData[] filterMostPopulousCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortDecreasingByPopulation();
        return Arrays.copyOf(sorted, howMany);
    }

    // Lọc ra howMany nước có dân số ít nhất.
    public CountryData[] filterLeastPopulousCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortIncreasingByPopulation();
        return Arrays.copyOf(sorted, howMany);
    }
    ...
    public CountryData[] filterLargestAreaCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortDecreasingByArea();
        return Arrays.copyOf(sorted, howMany);
    }
    ...
    public CountryData[] filterSmallestAreaCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortIncreasingByArea();
        return Arrays.copyOf(sorted, howMany);
    }
    ...
    public CountryData[] filterHighestGdpCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortDecreasingByGdp();
        return Arrays.copyOf(sorted, howMany);
    }
    ...
    public CountryData[] filterLowestGdpCountries(int howMany) {
        /* TODO */
        CountryData[] sorted = sortIncreasingByGdp();
        return Arrays.copyOf(sorted, howMany);
    }
